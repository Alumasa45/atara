...
export default function AdminSchedulesPage() {
    ...
    try {
      ...
      const payload = {
        ...
        timeSlots: validSlots.map((slot) => ({
          ...
          end_time: new Date(selectedDate + 'T' + slot.end_time).toISOString(),
        })),
      };
  ...
  const handleEditSchedule = (schedule: Schedule) => {
    ...
    const formattedSlots = schedule.timeSlots.map((slot) => ({
      ...
      start_time: new Date(slot.start_time).toLocaleTimeString('en-GB', {
        hour: '2-digit',
        minute: '2-digit',
        hour12: false,
      }),
      end_time: new Date(slot.end_time).toLocaleTimeString('en-GB', {
        hour: '2-digit',
        minute: '2-digit',
        hour12: false,
      }),
